  ...
  <div class="row justify-content-center">
    <div class="col-md-6 mt-5">
      <form action="" method="GET">
        <h2 class="mb-4">Logare</h2>  <a class="nav-link active" aria-current="page" href="index.php">Acasa</a>
        <div class="form-group mb-2">
          <label for="username">Nume de utilizator:</label>
          <input type="text" class="form-control" id="username" placeholder="Marcel075">
        </div>
        <div class="form-group mb-2">
        ...
        <div class="row">
          <div class="col">
            <button type="submit" class="btn btn-primary">Intra in cont</button> <div class="form-text">Nu aveți cont? <a href="inregistrare.php">Înregistrați-vă aici</a></div>
          </div>
          <div class="col">
